...
| -------------------------- |----------------------------------- |
| 模型版本              | vit_base   |
| 资源                   |  1 Nvidia Tesla V100-PCIE, CPU 3.40GHz; 8 Nvidia RTX 3090, CPU 2.90GHz |
| 上传日期              |  2021-11-29 |
| MindSpore版本          | 1.5.0 |
| 数据集                    |  CIFAR-10 |
| 训练参数        |  epoch=60, batch_size=32, lr_init=0.0065 or 0.052（1 or 8 GPUs）|
| 优化器                  |  Momentum |
| 损失函数              |  Softmax交叉熵 |
| 输出                    |  概率 |
| 分类准确率             |单卡: 98.84%; 八卡: 98.83%
| 速度                      | 单卡：467毫秒/步；八卡：469毫秒/步 |
| 总时长                 | 单卡: 12.1小时/60轮; 八卡: 1.52小时/60轮 |
